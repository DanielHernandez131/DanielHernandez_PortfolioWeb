...
export const translations = {
  es: {
    ...
    labLead: "Un experimento de composición generativa.<br>Cambia las reglas. Descubre el resultado.",
  ...
  en: {
    ...
    labLead: "An experiment in generative composition.<br>Change the rules. Explore the result.",
